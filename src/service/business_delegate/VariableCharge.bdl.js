...
const addURL = config.backendBaseURL + WSLinks.variableChargeAdd;
const getURL = config.backendBaseURL + WSLinks.variableChargeGet;
const getSumURL = config.backendBaseURL + WSLinks.variableChargeGetSum;
const updateURL = config.backendBaseURL + WSLinks.variableChargeUpdate;
